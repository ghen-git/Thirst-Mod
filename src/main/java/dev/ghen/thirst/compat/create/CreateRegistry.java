...
public class CreateRegistry
{
    ...
    public static final BlockEntry<SandFilterBlock> SAND_FILTER_BLOCK= Thirst.REGISTRATE.get()
            ...
            .register();
    public static final BlockEntityEntry<SandFilterTileEntity> SAND_FILTER_TE= Thirst.REGISTRATE.get()
